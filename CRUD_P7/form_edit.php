...
<body>
    <div class="container" width="740px;">
        <h1>Edit Barang</h1>
        <hr>
        <?php
        require "db_conn.php";
        ...
        <form action="aksi_barang.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-md-10"><input type="file" name="foto" id="foto" class="form-control">
                <a href="files/no-image.jpg" target="_new"><?=$data['foto']?></a>
                </div>
            </div>
            <div class="mb-3 row">
